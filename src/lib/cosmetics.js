...
export const EMBLEMS = [
  ...
  // Epics — showpieces
  { id: 'em_robot', collection: 'col_cyber',     type: 'emblem', name: 'Botto',       emoji: '🤖', rarity: 'epic',      source: { type: 'shop', price: 1000 },   tile: tile('#84f4ff', '#0e93cf', '#07304f') },
  { id: 'em_unicorn',   type: 'emblem', name: 'Sparklehorn', emoji: '🦄', rarity: 'epic',      source: { type: 'shop', price: 1000 },   tile: tile('#ffd3f6', '#c25ede', '#43126b') },
  { id: 'em_wizard',    type: 'emblem', name: 'Word Wizard', emoji: '🧙', rarity: 'epic',      source: { type: 'shop', price: 1000 },   tile: starTile('#b394ff', '#6524d6', '#1e0850') },
  { id: 'em_dragon', collection: 'col_dragon',    type: 'emblem', name: 'Dragon',      emoji: '🐉', rarity: 'epic',      source: { type: 'shop', price: 1000 },   tile: tile('#8bf7c6', '#0f9d6c', '#043321') },
  ...
  { id: 'em_oni',       type: 'emblem', name: 'Oni Mask',    emoji: '👺', rarity: 'legendary', source: { type: 'shop', price: 3000 },  tile: tile('#ff9d76', '#d92c1c', '#4d0703') },
  { id: 'em_crown', collection: 'col_royal',     type: 'emblem', name: 'Royalty',     emoji: '👑', rarity: 'legendary', source: { type: 'shop', price: 3000 },  tile: tile('#ffdf75', '#cd8306', '#4b2a00') },
  ...
  // Mythics — the chase
  { id: 'em_phoenix', collection: 'col_inferno',   type: 'emblem', name: 'Phoenix',     emoji: '🔥', rarity: 'mythic',    source: { type: 'shop', price: 6500 },  tile: tile('#ffc46b', '#f04c13', '#560b06') },
  { id: 'em_planet', collection: 'col_galaxy',    type: 'emblem', name: 'Ringworld',   emoji: '🪐', rarity: 'mythic',    source: { type: 'shop', price: 6500 },  tile: starTile('#c4b5fd', '#5b21b6', '#11043a') },
...
export const BANNERS = [
  ...
  { id: 'bn_sakura', collection: 'col_sakura',   type: 'banner', name: 'Cherry Blossom', rarity: 'epic',   source: { type: 'shop', price: 1000 },
  ...
  { id: 'bn_neon',     type: 'banner', name: 'Neon City',      rarity: 'epic',   source: { type: 'shop', price: 1000 },
  ...
  { id: 'bn_nebula',   type: 'banner', name: 'Nebula',         rarity: 'epic',   source: { type: 'shop', price: 1000 },
  ...
  { id: 'bn_cyber', collection: 'col_cyber',    type: 'banner', name: 'Cyberline',      rarity: 'epic',   source: { type: 'shop', price: 1000 },
  ...
  { id: 'bn_crystal',  type: 'banner', name: 'Crystal Cave',   rarity: 'epic',   source: { type: 'shop', price: 1000 },
  ...
  { id: 'bn_temple',   type: 'banner', name: 'Ancient Temple', rarity: 'legendary', source: { type: 'shop', price: 3000 }, shine: true,
  ...
  { id: 'bn_gold',     type: 'banner', name: 'Gilded',         rarity: 'legendary', source: { type: 'shop', price: 3000 }, shine: true,
  ...
  { id: 'bn_spooky',   type: 'banner', name: 'Spooky Night',   rarity: 'legendary', source: { type: 'shop', price: 3000 }, shine: true,
  ...
  { id: 'bn_winter', collection: 'col_winter',   type: 'banner', name: 'Winter Wonder',  rarity: 'legendary', source: { type: 'shop', price: 3000 }, shine: true,
  ...
  { id: 'bn_dragon', collection: 'col_dragon',   type: 'banner', name: 'Dragon Realm',   rarity: 'mythic', source: { type: 'shop', price: 6500 }, shine: true,
  ...
  { id: 'bn_rainbow',  type: 'banner', name: 'Rainbow Road',   rarity: 'mythic', source: { type: 'shop', price: 6500 }, shine: true,
  ...
  { id: 'bn_castle',      type: 'banner', name: 'Cloud Castle',  rarity: 'epic',      source: { type: 'shop', price: 1000 },
    css: 'linear-gradient(150deg, #6d28d9 0%, #3b1a8f 55%, #17073a 100%)' },
  { id: 'bn_cabin',       type: 'banner', name: 'Cozy Cabin',    rarity: 'epic',      source: { type: 'shop', price: 1000 },
    css: 'linear-gradient(160deg, #1e3a8a 0%, #16255c 55%, #080f2b 100%)' },
  { id: 'bn_elderwood',   type: 'banner', name: 'Elderwood',     rarity: 'epic',      source: { type: 'shop', price: 1000 },
    css: 'linear-gradient(160deg, #4c1d95 0%, #2a1150 55%, #0e0524 100%)' },
  { id: 'bn_lanterngrove',type: 'banner', name: 'Lantern Grove', rarity: 'epic',      source: { type: 'shop', price: 1000 },
    css: 'linear-gradient(150deg, #7c3aed 0%, #7c2d12 60%, #1c0a2e 100%)' },
  { id: 'bn_pagoda',      type: 'banner', name: 'Sky Pagoda',    rarity: 'legendary', source: { type: 'shop', price: 3000 }, shine: true,
    css: 'linear-gradient(150deg, #b06104 0%, #6b2d5b 55%, #221033 100%)' },
  { id: 'bn_skyship',     type: 'banner', name: 'Skyship',       rarity: 'legendary', source: { type: 'shop', price: 3000 }, shine: true,
    css: 'linear-gradient(150deg, #c2410c 0%, #6b21a8 60%, #1e0a38 100%)' },
  { id: 'bn_cosmos',      type: 'banner', name: 'Deep Cosmos',   rarity: 'legendary', source: { type: 'shop', price: 3000 }, shine: true,
...
export const BORDERS = [
  ...
  { id: 'bd_gold',     type: 'border', name: 'Royal Gold',    rarity: 'legendary', source: { type: 'shop', price: 3000 },
  ...
  { id: 'bd_royal', collection: 'col_royal',    type: 'border', name: 'Regalia',       rarity: 'legendary', source: { type: 'shop', price: 3000 },
  ...
  { id: 'bd_dragonscale', collection: 'col_dragon', type: 'border', name: 'Dragonscale', rarity: 'mythic',   source: { type: 'shop', price: 6500 },
  ...
  { id: 'bd_mythic',   type: 'border', name: 'Rainbow Aura',  rarity: 'mythic',    source: { type: 'shop', price: 6500 },
...
export const TITLES = [
  ...
  { id: 't_mind',      type: 'title', name: 'Mind Reader',      rarity: 'epic',      source: { type: 'shop', price: 1000 } },
  ...
  { id: 't_explorer',  type: 'title', name: 'World Explorer',   rarity: 'epic',      source: { type: 'shop', price: 1000 } },
  { id: 't_legend',    type: 'title', name: 'Living Legend',    rarity: 'legendary', source: { type: 'shop', price: 3000 } },
  { id: 't_guessmstr', type: 'title', name: 'Guess Master',     rarity: 'legendary', source: { type: 'level', level: 28 } },
  { id: 't_myth',      type: 'title', name: 'Myth Hunter',      rarity: 'mythic',    source: { type: 'shop', price: 6500 } },
...
export const NAME_COLORS = [
  ...
  { id: 'nc_neon', collection: 'col_cyber',     type: 'nameColor', name: 'Neon',          rarity: 'epic',      source: { type: 'shop', price: 1000 },  cls: 'name-neon' },
  { id: 'nc_gold', collection: 'col_royal',     type: 'nameColor', name: 'Gold',          rarity: 'legendary', source: { type: 'level', level: 12 },  cls: 'name-gold' },
  { id: 'nc_fire', collection: 'col_inferno',     type: 'nameColor', name: 'Fire Glow',     rarity: 'legendary', source: { type: 'shop', price: 3000 }, cls: 'name-fire' },
  { id: 'nc_champion', type: 'nameColor', name: 'Champion Glow', rarity: 'legendary', source: { type: 'shop', price: 3000 }, cls: 'name-champion' },
  { id: 'nc_mythic',   type: 'nameColor', name: 'Rainbow',       rarity: 'mythic',    source: { type: 'shop', price: 6500 }, cls: 'name-rainbow' },
  { id: 'nc_sakura',   type: 'nameColor', name: 'Rose Gold',     rarity: 'epic',      source: { type: 'shop', price: 1000 },  cls: 'name-rosegold', collection: 'col_sakura' },
  { id: 'nc_celestial',type: 'nameColor', name: 'Celestial',     rarity: 'epic',      source: { type: 'shop', price: 1000 },  cls: 'name-celestial', collection: 'col_galaxy' },
