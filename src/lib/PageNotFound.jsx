  ...
  return (
    <div className="h-dvh overflow-hidden flex items-center justify-center p-6 text-white relative">
      ...
      <div className="max-w-md w-full text-center">
        ...
        <p className="text-xl font-extrabold tracking-tight mb-1">Page Not Found</p>
        <p className="text-slate-400 text-sm font-medium mb-8">
          The page <span className="text-slate-200 font-semibold">"{pageName}"</span> doesn't exist.
        </p>
