...
export default function AuthLayout({ icon: Icon, title, subtitle, footer = null, children }) {
  return (
    ...
    <div className="dark h-dvh overflow-y-auto hide-scrollbar flex justify-center text-white px-4 py-8 pt-[max(env(safe-area-inset-top),2rem)] pb-[max(env(safe-area-inset-bottom),2rem)] relative">
      <GameBackground />
